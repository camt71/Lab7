...
public class MyWordCount {
	...
	public static final String fileName = "src\\lab7\\fit.txt";
	...
	public static void main(String[] args) {
		...
		System.out.println(Arrays.toString(count.exportWordCounts().toArray()));
		System.out.println(Arrays.toString(count.exportWordCountsByOccurence().toArray()));
//		System.out.println(Arrays.toString(count.filterWords("La").toArray()));
	}
}
